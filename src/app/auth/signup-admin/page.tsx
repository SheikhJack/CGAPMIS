...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const response = await fetch("/api/signupAdmin", {
        method: "POST",
  ...
  return (
    <div className="rounded-sm border  border-stroke bg-black text-white  shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex flex-wrap items-center ">
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="px-26 py-17.5 text-center">
            ...
            <p className="2xl:px-20 font-bold text-white">
              Welcome To PEEPA CGAPMIS
            </p>
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                <label htmlFor="name" className="mb-2.5 block font-medium text-white dark:text-white">
                  Name
                </label>
              ...
              <div className="mt-6 text-center">
                <p>
                  ...
                  <Link href="/auth/signin-admin" className="text-primary">
                    Sign in
                  </Link>
                </p>
              </div>
